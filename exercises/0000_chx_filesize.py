...
def plot_usage_versus_day(dfs, file_path, file_names):
    for i in range(len(dfs)):
        ...
        p.y_range.start = 0
        p.add_layout(Title(text="Time (days)", align='center', text_font_size="17px"), 'below')
        p.add_layout(Title(text='File Size (GB)', align='center', text_font_size="17px"), 'left')
        p.add_layout(Title(text=title_1 + ' : ' + title_2, align='center', text_font_size="20px"), 'above')
        show(p)
...
def plot_usage_versus_week(dfs, file_path, file_names):
    for i in range(len(dfs)):
        ...
        p.xgrid.grid_line_color = None
        p.y_range.start = 0
        p.add_layout(Title(text="Time (weeks)", align='center', text_font_size="17px"), 'below')
        p.add_layout(Title(text='File Size (GB)', align='center', text_font_size="17px"), 'left')
        p.add_layout(Title(text=title_1 + ' : ' + title_2, align='center', text_font_size="20px"), 'above')
        show(p)
...
def plot_usage_versus_month(dfs, file_path, file_names):
    for i in range(len(dfs)):
        ...
        p.xgrid.grid_line_color = None
        p.y_range.start = 0
        p.add_layout(Title(text="Time (months)", align='center', text_font_size="17px"), 'below')
        p.add_layout(Title(text='File Size (GB)', align='center', text_font_size="17px"), 'left')
        p.add_layout(Title(text=title_1 + ' : ' + title_2, align='center', text_font_size="20px"), 'above')
        show(p)
